...
set_false_path -from [get_ports {reset button* rxd ps2_clk ps2_data}] -to *
...
set_output_delay -clock PLL_inst|altpll_component|pll|clk[1] -max 5.0 [get_ports {flash_a* flash_we_n flash_reset_n flash_ce_n flash_oe_n}]
set_output_delay -clock PLL_inst|altpll_component|pll|clk[1] -min 0.0 [get_ports {flash_a* flash_we_n flash_reset_n flash_ce_n flash_oe_n}]